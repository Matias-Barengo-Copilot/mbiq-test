...
class WelcomeEducator extends StatelessWidget {
  final Function changeView;
  WelcomeEducator({required this.changeView});
                      ...
                      SizedBox(
                        ...
                        child: Container(
                            ...
                            child: RawMaterialButton(
                              ...
                              onPressed: () => {},
                              child: const Text("Go To Venue Dashboard",
                                  style: TextStyle(
                                    color: PersonalColors.colorPrimary,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18.0,
                      ...
                      SizedBox(
                        ...
                        child: Container(
                            ...
                            child: RawMaterialButton(
                              ...
                              child: const Text("Set up a Class",
                                  style: TextStyle(
                                    color: PersonalColors.colorPrimary,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18.0,
