...
//void main() => runApp(const CompleteProfileEducator1());

class CompleteProfileEducator1 extends StatelessWidget {
  //const CompleteProfileEducator1({Key? key}) : super(key: key);
  final Function changeView;
  CompleteProfileEducator1({required this.changeView});

  @override
  Widget build(BuildContext context) {
    return CompleteProfile1(changeView: changeView);
  }
}

class CompleteProfile1 extends StatelessWidget {
  final Function changeView;
  CompleteProfile1({required this.changeView});
          ...
          SizedBox(
            child: FractionallySizedBox(
              ...
              child: RawMaterialButton(
                ...
                onPressed: () {
                  changeView(1); // Cambiar al Widget2
                },
                child: Row(
...
// class CompleteProfileEducator1 extends StatefulWidget {
//   const CompleteProfileEducator1({Key? key}) : super(key: key);

//   @override
//   _CompleteProfileEducator1State createState() =>
//       _CompleteProfileEducator1State();
// }

// class _CompleteProfileEducator1State extends State<CompleteProfileEducator1> {
//   int _currentIndex = 0;
